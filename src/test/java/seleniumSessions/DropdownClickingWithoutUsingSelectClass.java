...
public class DropdownClickingWithoutUsingSelectClass {
...
//		driver.findElement(By.xpath("//*[@id=\"_in_kw\"]")).click();		//		Clicking without using select class
//		driver.findElement(By.xpath("//select//option[contains(text(),'Exact words, exact order')]")).click();		//		Clicking without using byvisibletext method.
		Select select = new Select(driver.findElement(By.xpath("//*[@id=\"_in_kw\"]")));		//	to select drop down list we have to create a object which is having the path to drop down list. 
																																					...
																																					// Absolute XPath should not be used it comes from highrarity	-	https//body/fieldset[1]/div[3]/button 
